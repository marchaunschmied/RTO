/**
 ******************************************************************************
 * @file    TftFont_16x24.c
 * @author  Julian Grasböck
 * @version V1.0.0
 * @date    22.11.2017
 * @brief   Declaration of the bitmap array and the font struct
 * @copyright
...
#include "TftFont_16x24.h"

/****************************************************************
 * Module intern constants
 ***************************************************************/
 
/**
 * @brief Array containing the bitmaps for the fonts characters
 */
static const uint8_t Bitmaps_16x24[(144-32)*48] = {
  /* 0x20: Space ' ' */
...
/**
 * @brief Declaration of the Font
 */
TftFontType const TftFont_16x24 = {
  16,           /**< Width of each char */
  24,           /**< Height of each char */
  32,           /**< ASII offset of the first char in the bitmap array */
  112,          /**< Number of characters in the bitmap array */
  Bitmaps_16x24 /**< Array containing all character bitmaps */
};
